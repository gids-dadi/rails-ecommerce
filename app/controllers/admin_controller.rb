class AdminController < ApplicationController
  ...
  def index
    @unfulfilled_orders = Order.where(fulfilled: false).order(created_at: :desc).take(5)
...
if @revenue_by_day.count < 7
  ...
  ordered_days_with_current_last = days_of_week[current_day_index..-1] + days_of_week[0...current_day_index]
